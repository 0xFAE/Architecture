...
the effect of replacement policy, not many were found or mostly gave poor results [21],[22] . Most of them focused on different approaches 
such as recent static prediction [1] and using a hashed value for indexing branch predictors table [51]. Other works that studied dead-block 
prediction mainly focused on using it in power reduction[44], cache optimization[46] or bypassing[33]. Hence, our efforts will be focus on studying the use of dead block prediction
