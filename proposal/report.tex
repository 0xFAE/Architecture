...
\begin{abstract}
	For our final project, we implemented a global history replacement policy for instruction cache and branch target buffer.
	The original method lowered instruction cache MPKI by an average of 18\% over the least recently-used policy, and it showed
